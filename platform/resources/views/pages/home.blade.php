...
@section('content')
    ...
    <section class="py-12 bg-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center items-center gap-10 grayscale opacity-40 hover:opacity-60 transition-opacity duration-500">
                <span class="text-lg font-bold text-gray-400">IOM</span>
                <span class="text-lg font-bold text-gray-400">Swiss Embassy</span>
                <span class="text-lg font-bold text-gray-400">British Embassy</span>
                <span class="text-lg font-bold text-gray-400">ACDC</span>
